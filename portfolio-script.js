...
document.querySelectorAll('.project-card, .skill-item, .stat-item, .hackathon-item').forEach(el => {
    observer.observe(el);
});
...
console.log(`
🚀 Krushna Saruk's Portfolio
📧 Contact: krushna.saruk@email.com
💻 GitHub: github.com/krushnasaruk
📺 YouTube: youtube.com/@reviewer
`);
